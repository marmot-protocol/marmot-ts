 ...
 * inside one shared `messages.json` file: the rumor-history backend for a group
 * is handed a `PrefixedKeyValueStore` scoped to `${groupHex}:`, and never sees
 * (or can clear) another group's rumors.
 */
